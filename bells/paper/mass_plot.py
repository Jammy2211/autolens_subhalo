...
bells_keys = util.bells_mass_keys_list_from()
...
for i, key in enumerate(bells_keys):
    ...
    try:
        ...
        mass_pl_list.append(1e13)
        upper_pl_list.append(0.0)
        lower_pl_list.append(0.0)
    ...
    try:
        ...
        mass_decomp_list.append(1e13)
        upper_decomp_list.append(0.0)
        lower_decomp_list.append(0.0)

plot_path = path.join("paper", "images", "masses")

x_centre = np.arange(len(bells_keys))
x_left = x_centre - 0.1
